    ...
    <section class="container hero">
        <div class="row align-items-center h-100">
            <div class="col-12 col-lg-6">
                ...
                <p class="mb-4">Selamat datang di ThinkTank, ruang terbuka bagi para pemikir kritis, inovator, dan
                    pembelajar untuk berdiskusi, berbagi ide, dan menciptakan solusi nyata.</p>
            ...
            <div class="row">
                <div class="col-12 col-lg-4 mb-3">
                    <div class="card">
                        ...
                        <p class="mb-5">I am working on a blogging application in Laravel 8. There are 4 user roles, among
                            which, the ...</p>
                        <div class="row">
                ...
                <div class="col-12 col-lg-4 mb-3">
                    <div class="card">
                        ...
                        <p class="mb-5">I am working on a blogging application in Laravel 8. There are 4 user roles,
                            among which, the ...</p>
                        <div class="row">
                            <div class="col me-1 me-lg-2">
                                <a href="/"><span class="badge rounded-pill text-bg-light">Eloquent</span></a>
